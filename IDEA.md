...
- [/] #160 — 1.7.3 pin свойств: `STATE.pinnedProperties` (сессионный), кнопка-булавка
  ...
  Выделение закреплённых: подложка `--ac-accent-soft` + горизонтальная акцентная полоса сверху
  (inset box-shadow 0 2px 0, без сдвига layout), заголовок группы — акцентным цветом; учтено
  ...
  закреплённое, выбор строки. Визуальная
