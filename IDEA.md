...
2026-09-25 — реорганизация состояния: закрыты #193/#199/#205/#206/#161, завершённые блоки перенесены в `IDEA_ARCHIVE.md`. По #209: фильтр восстановлен, clang-format, clangd 0, карточка Helpers обновлена. Ранее 34/34 строки имели наименование лишь с ошибочно расширенным фильтром — исправлением #209 это не считается.
...
- #194 `3ccd662`: SyncShowSubelement «показать родительские» — выделить ребёнка → показать родителя, и наоборот.
- #203 `b6fa2a3`: RunParam запускает script маркера проёма — окно и дверь с маркером (порядок основной → маркер) и случай без маркера.
- #189 `2213388`: инлайн-кнопка сброса убрана из строк «Монитора»; в строке осталась только кнопка закрепления.
- #204 `fc29e77`: закрепление групп свойств в «Мониторе»; проверить pin/unpin группы и сочетание с закреплённым свойством.
- Ревизия Sync `9ae0138` (#194/#199): GUI диалога другой базы (заголовок/подписи из ресурсов), реальный `Sync_to_GUID` и откат на PLN; AC22–29 не проверены.
...
- Прочее: #191 (лог пути настроек), #156 (классификатор видов работ), #155 (быстрый сброс свойств), #149/#148/#147 (откосы), #143/#142/#141 (чтение атрибутов), #136 (геометрия перекрытий), #130/#129/#128 (фильтры/поиск), #115 (координаты окон/дверей).
