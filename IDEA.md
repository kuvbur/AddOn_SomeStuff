...
## Task
#207/#208/#209 завершены для AC25 и перенесены в `IDEA_ARCHIVE.md`; другие параллельные задачи сохранены ниже.

## Scope
Завершённый scope: JSON Spec, пустое выделение, наименование из материала (AC25). Новых изменений в Spec не запланировано.

## Status
COMPLETED — checkpoint `50cae05`; issues #207/#208/#209 закрыты. AC26–29/macOS и смешанное создание/изменение — not verified.

## Last Completed
2026-09-25 — AC25 `SomeStuffCommand.Spec`: `completed`, `resultCode=0`, `elementsToCreate=34`; объектов 548→582, последние 34/34 имеют заполненное наименование материала. Старый фоновый вызов с ошибкой начат до исправления #209.

## Next Step
При необходимости отдельно выбрать проверку AC26–29/macOS или смешанного создания/изменения; другие задачи — в блоках ниже.

## Last Checkpoint
`50cae05` — `[spec-7] Non-interactive Spec and material names` (`Refs: #207 #208 #209`).

## Plan
- [x] #207/#208/#209: исправить, собрать и проверить на AC25; результат перенесён в `IDEA_ARCHIVE.md`.
