...
2026-09-14: backlog вынесен в GitHub issues (см. Decisions) — работать по ним, номера фиксировать
в коммит-сообщениях и трекере.
...
- 2026-09-14: backlog вынесен в GitHub issues: 1.5 → #157, 1.7.1 → #158, 1.7.2 → #159, 1.7.3 → #160,
  Sync.cpp-8 → #161, ResetProperty.cpp-4 → #162, R2–R10 → #163–#171; 1.6 = существующий #155
  (комментарий привязан). Трекер: `Reviews/open-2026-09-12.tracker.csv` — колонка issue заполнена.
  Правило: новые пожелания/баги → сначала GitHub issue, потом в IDEA.md/трекер со ссылкой.
