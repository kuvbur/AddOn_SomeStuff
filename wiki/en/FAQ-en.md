...
### The add-on is installed, but nothing works. What should I do?
...
2. The flag property is available for the element. A flag property is a property whose description contains `Sync_flag`. Available means that this property is visible in the element's parameters. More details about the setup are [written here](https://github.com/kuvbur/AddOn_SomeStuff/wiki/GDLParameter2Property-en)
...
6. Ensure that processing for the corresponding element type is enabled.
