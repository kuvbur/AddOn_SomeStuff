...
![Пример 1](https://github.com/kuvbur/AddOn_SomeStuff/blob/master/wiki/all.PNG)
...
8. Copying IFC properties to regular properties.
9. Writing and reading project data to the element properties.
