...
API_Neig **ClickElements_Neig (const char *prompt, API_ElemTypeID needTypeID, Int32 *nItem);

API_Elem_Head **ClickElements_ElemHead (const char *prompt, API_ElemTypeID needTypeID, Int32 *nItem);
