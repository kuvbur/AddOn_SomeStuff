...
struct RuleSelectData {
    /// Набор правил и их состояние (включено/выключено).
...
/// Представляет собой модальное окно с таблицей правил, поддерживает
/// переключение состояния правила по щелчку по чекбоксу.
