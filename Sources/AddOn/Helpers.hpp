...
// ’ранение данных параметра
// type - API_VariantType (как у свойств)
// name - им€ дл€ поиска
// uniStringValue, intValue, boolValue, doubleValue - значени€
// canCalculate - можно ли использовать в математических вычислени€х
typedef struct {
	...
	API_PropertyDefinition definition = {}; // ќписание свойства, чтоб не искать
	// “ут храним способ, которым нужно получить значение
	bool isGDLparam = false; // Ќайден в гдл параметрах
	bool isProperty = false; // Ќайден в свойствах
	bool isMorph = false; // Ќайден свойствах морфа
	bool isInfo = false; // Ќайден в инфо о проекте
...
// —ловарь с заранее вычисленными данными дл€ калькул€тора
typedef GS::HashTable<GS::UniString, ParamValue> ParamDictValue;

// —ловарь с параметрами дл€ вычислени€
// —лужит дл€ формировани€ уникального списка свойств и параметров
typedef GS::HashTable<GS::UniString, bool> ParamDict;

// —ловарь с параметрами дл€ записи
