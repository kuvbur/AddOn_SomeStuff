...
struct DimRule {
    ...
    GS::UniString expression = EMPTYSTRING;
    GS::UniString layer = EMPTYSTRING;
...
namespace ParamHelpers {
    ...
    // там прежде не было
    // --------------------------------------------------------------------
    void AddParamValue2ParamDictElement (const API_Guid &elemGuid,
    ...
    // --------------------------------------------------------------------
    void AddParamDictValue2ParamDictElement (const API_Guid &elemGuid,
