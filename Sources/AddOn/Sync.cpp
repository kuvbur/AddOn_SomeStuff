...
using SyncDialogs::AddOtherDbTarget;
using SyncDialogs::GetOtherStoryName;
using SyncDialogs::OtherDbTarget;
using SyncDialogs::ShowOtherDbDialog;
...
// Если syncSettings.GetSyncMon() включён - привязывает элементы к мониторингу (AttachObserver)
